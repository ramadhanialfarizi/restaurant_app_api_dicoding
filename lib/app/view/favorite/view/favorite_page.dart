...
import 'package:restaurant_app_api_dicoding/app/view/favorite/view/widget/empty_favorite.dart';
              ...
              children: [
                ...
                Consumer<FavoriteProvider>(
                  builder: (context, favoriteProv, __) {
                    if (favoriteProv.state == ResultState.loading) {
                      return const Center(
                        child: CircularProgressIndicator(),
                      );
                    } else if (favoriteProv.state == ResultState.hasData) {
